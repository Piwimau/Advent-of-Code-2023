...
[Advent of Code 2023](https://adventofcode.com/2023), my third year of
participation.
...
Many users compete on the
[global leaderboard](https://adventofcode.com/2023/leaderboard) by solving the
puzzles in an unbelievably fast way in order to get some extra points.
Personally, I see Advent of Code as a fun exercise to do during the Advent
season while waiting for Christmas. I often use it to learn a new programming
language (like I did in 2021 with `C#`) or some advanced programming concepts. I
can only encourage you to participate as well - of course in a way that you find
